...
from resources.pipelines.personal_website.config import (role_name, profile_name, policy_name, code_build_name, repo_url,
                                                         docker_image)
from resources.s3.artifacts.config import bucket_name as artifact_bucket_name
from resources.s3.nickplutt_com.config import bucket_name as nickplutt_com_bucket_name
